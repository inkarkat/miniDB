...
@test "update of a table with an existing key and numeric column overwrites that column's value" {
...
@test "update of a table with an existing key and schema name column overwrites that column's value" {
    initialize_table "$BATS_TEST_NAME" from one-entry
...
@test "update of a table with an existing key and multiple numeric columns overwrites the column values" {
...
@test "update of a table with an existing key and multiple schema name columns overwrites the column values" {
    initialize_table "$BATS_TEST_NAME" from multiline-schema
...
@test "update of a table with an existing key and numeric key overwrites the key" {
    initialize_table "$BATS_TEST_NAME" from one-entry
...
@test "update of a table with an existing key and schema name key overwrites the key" {
    initialize_table "$BATS_TEST_NAME" from one-entry
...
@test "update of a table with an existing key and multiple columns overwrites the column values also when given in arbitrary order" {
    initialize_table "$BATS_TEST_NAME" from multiline-schema
...
@test "update of a table with an existing key and multiple mixed numeric and schema name columns overwrites the column values also when given in arbitrary order" {
    initialize_table "$BATS_TEST_NAME" from multiline-schema
